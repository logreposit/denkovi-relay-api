...
@Service
public class DenkoviRelayService
{
    private static final Logger logger = LoggerFactory.getLogger(DenkoviRelayService.class);

    private final DenkoviSerialClient denkoviSerialClient;

    public DenkoviRelayService(DenkoviSerialClient denkoviSerialClient)
    {
